...
public class ProcessResult {
	...
	public double m_rotateDistance = 0;
	...
	public void process(){
		...
		if (m_targetLeft!= null && m_targetRight != null)
		{
			...
			m_rotateDistance = m_targetRight.m_distanceFromHeight - m_targetLeft.m_distanceFromHeight;
		}
		else if (m_targetLeft!= null)
		{
			m_distance = m_targetLeft.m_distanceFromHeight;
			m_sideDistance = Target.CalculateDistance(m_targetLeft.m_centerX - screenCenterX,
		...
		else if (m_targetRight!= null)
		{
			...
			m_sideDistance = Target.CalculateDistance(screenCenterX - m_targetRight.m_centerX,
		...
		builder.append(", rotate="+TraceLog.Round2(m_rotateDistance));
